...
public class TarjanAlgo {
    ...
    public static void dfs(ArrayList<ArrayList<Edge>> graph, int curr, int par, int dt[], int low[], boolean vis[], int time) {
        vis[curr] = true;
    ...
    public static void tarjanBridge(ArrayList<ArrayList<Edge>> graph, int V) {
        int dt[] = new int[V];
        int low[] = new int[V];
        int time = 0;
